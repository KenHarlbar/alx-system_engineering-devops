# Web server
Project done during **Full Stack Software Engineering studies** at **The ALX Holberton SE programme**. It aims to learn about the roles of web servers and their processes (parent and child), and DNS roles.
